...
$sql = "SELECT e.apellidos, e.nombre FROM empleado AS e, usuario AS u WHERE e.estado = 'A' AND e.idempleado = u.idempleado AND u.tipo_usuario = 'Vendedor' ORDER BY e.idempleado";

$Query = $conexion->query($sql);

$Query1 = $conexion->query($sql);

$sqlCat = "SELECT idcategoria, nombre FROM categoria ORDER BY idcategoria";
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 left">
                    <div class="form-group has-success">
                        ...
                        <?php
                            while ($fila = $queryCat->fetch_object()) {
                        ?>
