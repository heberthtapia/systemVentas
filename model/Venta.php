<?php
	...
	class Venta{
		...
		public function Modificar($idventa,$idpedido, $idusuario,$tipo_venta,$tipo_comprobante,$serie_comprobante,$num_comprobante,$impuesto,$total,$estado){
			...
			$date = date( 'Y-m-d' ); /*curdate()*/
			$hour = date('H:i:s');
			$sql = "UPDATE venta set idpedido = '$idpedido',idusuario='$idusuario',tipo_venta='$tipo_venta',serie_comprobante	='$serie_comprobante',num_comprobante='$num_comprobante', fecha = '$date', hora='$hour', impuesto='$impuesto',total='$total',estado='$estado'
